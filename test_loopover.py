class TestLoopoverPuzzle:
    def test_get_solution(self):
        from linear_puzzle import LoopoverPuzzle
    ...
    def test_apply_tri_rot(self):
        from linear_puzzle import LoopoverPuzzle, Rot
...
class TestRotComp:
    def test_compressed(self):
        from linear_puzzle import RotComp, LinearPuzzle
...
class TestMoveComp:
    def test_compressed(self):
        from linear_puzzle import LoopoverPuzzle, MoveComp
        loopover_puzzle_a = LoopoverPuzzle.from_shape((10, 10), randomize=True)
        loopover_puzzle_b = loopover_puzzle_a.copy()
